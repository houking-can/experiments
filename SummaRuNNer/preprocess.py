...
def worker(files):
    ...
    for f in files:
        ...
        # labels = [str(i) for i in paper['extracted']]
        tmp = paper['extracted']
...
if __name__ == '__main__':
    ...
    parser.add_argument('-build_vocab',default=True)
    parser.add_argument('-embed', type=str, default='/home/yhj/dataset/emnlp_mix_int_he/word2vec.128d.139k.w2v')
    ...
    parser.add_argument('-source_dir', type=str, default='/home/yhj/dataset/emnlp_mix_int_he')
    parser.add_argument('-target_dir', type=str, default='data/he')
