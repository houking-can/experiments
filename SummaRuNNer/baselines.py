...
def upper_bound():
    for split in ['test', 'val']:
        ...
        dec_order = '/home/yhj/emnlp/baseline_mix/upperbound_%s_km/output' % split
        path = os.path.join('/home/yhj/dataset/emnlp_mix_int_km', split)
        ...
        ref_dir = os.path.join('/home/yhj/dataset/emnlp_mix_int_km/refs/', split)
        ...
        print('%s order:' % split)
        print(output)
        with open('/home/yhj/emnlp/baseline_mix/upperbound_%s_km/rouge.txt' % split, 'w') as f:
            f.write(output)


if __name__=="__main__":
    # test_path = '/home/yhj/dataset/emnlp_mix_int_he/test'
    # decoder_path = '/home/yhj/emnlp/baseline_mix'
    # ref_dir = '/home/yhj/dataset/emnlp_mix_int/refs/test'
    ...
    #     with open(join(res_dir,'rouge_5.txt'), 'w') as f:
    #         f.write(output)
