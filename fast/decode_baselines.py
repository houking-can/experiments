...
if __name__ == '__main__':
    ...
    parser.add_argument('--path', default='/home/yhj/emnlp/fast/logroot/decoder_baseline', help='path to store/eval')
    parser.add_argument('--abs_dir', default='/home/yhj/emnlp/fast/logroot/abstractor',help='root of the abstractor model')
    parser.add_argument('--ext_dir', default='/home/yhj/emnlp/fast/logroot/extractor',help='root of the extractor model')
    ...
    parser.add_argument('--max_dec_word', type=int, action='store', default=210,
