...
try:
    _DATA_DIR = '/home/yhj/dataset/emnlp/'
except KeyError:
...
if __name__ == '__main__':
    ...
    metric_opt.add_argument('--rouge', default=True,
    ...
    parser.add_argument('--decode_dir', action='store', default='/home/yhj/emnlp/fast/logroot/decoder_baseline',
