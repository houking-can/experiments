...
if __name__ == '__main__':
    ...
    parser.add_argument('--path', default='/home/yhj/emnlp/fast/logroot/decoder_rl',
                        help='path to store/eval')
    parser.add_argument('--model_dir', default='/home/yhj/emnlp/fast/logroot/full_rl',
