...
if __name__ == '__main__':
    ...
    parser.add_argument('--path', default='./logroot', help='root of the model')
    ...
    parser.add_argument('--w2v', action='store', default="/home/yhj/dataset/emnlp/word2vec.128d.72k.bin",
    ...
    # length limit
    parser.add_argument('--max_word', type=int, action='store', default=50,
                        help='maximun words in a single article sentence')
    parser.add_argument('--max_sent', type=int, action='store', default=80,
    ...
    args.path = os.path.join(args.path,'extractor')
    main(args)
