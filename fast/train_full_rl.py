...
if __name__ == '__main__':
    ...
    parser.add_argument('--path', default='/home/yhj/emnlp/fast/logroot', help='root of the model')


    # model options
    parser.add_argument('--abs_dir', action='store',default='/home/yhj/emnlp/fast/logroot/abstractor',
                        help='pretrained summarizer model root path')
    parser.add_argument('--ext_dir', action='store',default='/home/yhj/emnlp/fast/logroot/extractor',
    ...
    args.path = os.path.join(args.path, 'full_rl')
    train(args)
