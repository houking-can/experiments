...
if __name__ == '__main__':
    ...
    # length limit
    parser.add_argument('--max_art', type=int, action='store', default=50,
                        help='maximun words in a single article sentence')
    parser.add_argument('--max_abs', type=int, action='store', default=80,
    ...
    args.path = os.path.join(args.path,'abstractor')
    main(args)
